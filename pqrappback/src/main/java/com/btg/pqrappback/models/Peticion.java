...
public class Peticion {
    ...
    public Peticion(String titulo, String detalle, Date fechaDeCreacion, Boolean areaAdminDioRta, Date fechaDeRespuestaAdmin, String respuestaAreaAdmin) {
        this.titulo = titulo;
